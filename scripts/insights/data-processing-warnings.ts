...
const UNIQUE_PERIODS_LOOKUP_WARNING = `unique-periods-lookup warning - The data includes some periods which are not included in our list of unique periods. To regenerate the unique-periods-lookup.csv, run the command: npm run data:periods.`;
