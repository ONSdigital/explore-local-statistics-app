<script lang="ts">
	...
	import { pivotData } from '$lib/util/datasets/datasetsHelpers';
...
<NavSections contentsLabel="Explore this dataset" marginTop>
  ...
  <NavSection title="Timeseries">
	...
	<NavSection title="Get the data">
		<p>
			This dataset was produced by the Office for National Statistics. The original source data can
			be <a href="#0">found here</a>.
		</p>
		<p>
